...
namespace DirectX
{
	namespace Internal
	{
		// base class, not to be used directly; should be used via the derived PrimitiveBatch<T>
		class PrimitiveBatchBase
		{
		protected:
			PrimitiveBatchBase(_In_ ID3D11DeviceContext* deviceContext, size_t maxIndeces, size_t maxVertices, size_t vertexSize);
...
// template that makes the API typesafe, e.g. PrimitiveBatch<VertexPositionColor>
